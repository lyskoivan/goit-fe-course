...
Account.prototype.getInfo = function() {
  console.log(`Hello ${this.login}, your email: ${this.email}`)
}; 
...
const secondUser = new Account('bassa', 'mango@dsadsad.woof');

secondUser.getInfo(); // Login: Mangozedog, Email: mango@dog.woof